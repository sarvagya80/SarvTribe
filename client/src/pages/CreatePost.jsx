    ...
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-6 '>
        ...
        <div className='max-w-xl bg-white p-4 sm:pb-3 rounded-xl shadow-md space-y-4'>
         ...
         <textarea className='e-full resize-none max-h-20 mt-3 text-sm outline-none placeholder-gray-400 '
         placeholder='whats happening' onChange={(e)=> setContent(e.target.value)} value={content}/>
         {
         ...
         <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
          <label htmlFor='images' className='flex-center gap-2 text-sm text-gray-500 hover:text-gray-700 transition cursor-pointer'>
