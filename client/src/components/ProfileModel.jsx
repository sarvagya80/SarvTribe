          ...
          <form className='space-y-4' onSubmit={handleSaveProfile}> 
           {/*profile picture */}
            <div className='flex flex-col items-start gap-3'>
              <label htmlFor='profile_picture' className='block text-sm font-meddium text-gray-700 mb-1'> Profile Picture 
            ...
            <label htmlFor='cover_photo' className='block text-sm font-medium text-gray-700 mb-1'>
               Cover Photo
                ...
                <div className='group/cover relative'>
                  <img src={editForm.cover_photo ? URL.createObjectURL(editForm.cover_photo):user.cover_photo } className='w-80 h-40 rounded-lg bg-gradient-to-r from-indigo-200 via-purple-200 to-pink-200 object-cover mt-2'/>
           ...
           <div>
              ...
              <input type='text' className='w-full p-3 border border-gray-200 rounded-lg' placeholder='Please enter your Location' onChange={(e)=>setEditForm({...editForm,locatiion: e.target.value})} value={editForm.locatiion}/>
            
           </div>
           <div className='flex justify-end space-x-3 pt-6'>
            <button onClick={()=>setShowEdit(false)} type='button' className='px-4 py-2 borderr border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors cursor-pointer'>Cancel</button>
            <button type='submit'  className='px-4 py-4 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-lg hover:fromm-indigo-600 hover:to-purple-700 transition cursor-pointer'>Save Changes</button>
